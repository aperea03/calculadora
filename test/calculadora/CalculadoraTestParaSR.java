...
public class CalculadoraTestParaSR {

	// atributos de la clase CalculadoraTetsPara
	int nTest;
	double num1;
	double num2;
	double resulExp;
	...
	// constructor de la clase CalculadoraTetsPara
	public CalculadoraTestParaSR(int nTest, double num1, double num2, double resulExp
	...
	@Parameters
	 ...
	 Object[][] data = new Object[][] { {1,6,2,8,30,10,20}, {2,8,2,11,4,3,1}, {3,10,2,12,10,5,6} } ;
	...
	public void restaTest() {
		System.out.println("  ejecutando restaTest "+ this.nTest + "....");
